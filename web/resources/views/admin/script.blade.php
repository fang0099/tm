		...
		<script src="public/admin/assets/js/date-time/bootstrap-datepicker.zh-CN.js"></script>
		<script src="public/admin/assets/js/ajaxfileupload.js"></script>
		<script src="public/admin/assets/js/bean.js"></script>
		<script src="ueditor/ueditor.config.js"></script>
		<script src="ueditor/ueditor.all.js"></script>
		<script src="public/admin/assets/js/jquery.multiselect.js"></script>
		<script src="public/admin/assets/js/jquery.multiselect.zh-cn.js"></script>
		<script src="public/admin/assets/js/jquery.colorbox-min.js"></script>
