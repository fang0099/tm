                ...
                <div class="col-lg-9">
                    <div class="blog-single-content bordered blog-container">
                        <div class="blog-single-head">
                            ...
                            <a href="<?php echo env('APP_URL');?>/article/like?id={{$article["id"]}}" class="btn btn-circle yellow">喜欢</a>
                            <a href="<?php echo env('APP_URL');?>/article/collect?id={{$article["id"]}}" class="btn btn-circle yellow">收藏</a>
                        ...
                        <div class="blog-comments">
                            ...
                            <form action="<?php echo env('APP_URL');?>/article/comment" method="post">
                                <div class="form-group">
                                    <input name="id" value="{{$article["id"]}}" style="display: none;"/>
                                    <textarea rows="8" name="comment" placeholder="写评论 ..." class="form-control c-square"></textarea>
                                </div>
                                <div class="form-group">
