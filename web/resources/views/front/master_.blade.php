                    ...
                    <div class="hor-menu  ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-dropdown classic-menu-dropdown ">
                                <a href="<?php echo env('APP_URL');?>/tag/article?id=1">tag1
                                    <span class="arrow"></span>
                                </a>
                            </li>
                            <li class="menu-dropdown classic-menu-dropdown ">
                                <a href="<?php echo env('APP_URL');?>/tag/article?id=2">tag2
                                    <span class="arrow"></span>
                                </a>
                            </li>

                            <li class="menu-dropdown classic-menu-dropdown ">
                                <a href="<?php echo env('APP_URL');?>/tag/article?id=3">tag3
                                    <span class="arrow"></span>
                                </a>
                            </li>

                            <li class="menu-dropdown classic-menu-dropdown ">
                                <a href="<?php echo env('APP_URL');?>/tag/article?id=4">tag4
                                    <span class="arrow"></span>
                                </a>
                            </li>
