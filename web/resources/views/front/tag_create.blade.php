            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase"> 添加标签</span>
                    </div>
                    <div class="actions">
                    ...
                    <form role="form" class="form-horizontal" action="/tm/web/public/tag/create" method="post" enctype="multipart/form-data">
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="form_control_1" name="name" placeholder="标签名" value="">
                            ...
                            <div class="form-group form-md-line-input ">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="form_control_1" placeholder="简介" name="brief" value="">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                        </div>
